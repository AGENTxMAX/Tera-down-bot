...
async def start_command(client, message):
    ...
    join_button = InlineKeyboardButton("Join ❤️🚀", url="https://t.me/AgentxMax")
    developer_button = InlineKeyboardButton("Developer ⚡️", url="https://t.me/AgentxMax")
...
async def start_command(client, message):
    ...
    if verify_status["is_verified"]:
        ...
        if IS_VERIFY:
            ...
            link = await get_shortlink(SHORTLINK_URL, SHORTLINK_API, f'https://t.me/teraboxdownloaderxx_bot?start=verify_{token}')
            ...
            tutorial_button = InlineKeyboardButton("How to Verify", url="https://t.me/AgentxMax/3")
